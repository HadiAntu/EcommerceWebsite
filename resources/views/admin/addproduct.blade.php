...
<div class="mb10">
  ...
  @endif --}}
    ...
    <div class="form-group">
      ...
      <input type="text" name="Product_name" class="form-control" id="Product_name" aria-describedby="emailHelp" placeholder="Product_name">
 ...
 @enderror
    ...
    <div class="form-group">
      ...
      <input type="number" name="Product_quantity" class="form-control" min="0" id="Product_quantity" placeholder="Product_quantity">
      <small id="emailHelp" class="form-text text-muted">Please Provide A New Category slug.</small>
    </div>
    <div class="form-group">
      <label for="Product_price">Product Price</label>
      <input type="number" name="Product_price" class="form-control" id="Product_price" placeholder="Product_price">
      <small id="emailHelp" class="form-text text-muted">Please Provide A New Category slug.</small>
    </div>
    <div class="form-group">
